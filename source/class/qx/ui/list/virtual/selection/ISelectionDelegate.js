 ...
 * really implemented.
 */
qx.Interface.define("qx.ui.list.virtual.selection.ISelectionDelegate", {
  members: {
    /**
     ...
     * as items. The {@link qx.ui.list.virtual.cell.Cell} uses cells as items. Cells are represented by
